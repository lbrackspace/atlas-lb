...
public final class SslTerminationHelper {
    ...
    public static org.openstack.atlas.service.domain.entities.SslTermination verifyAttributes(SslTermination apiSslTermination, org.openstack.atlas.service.domain.entities.SslTermination dbTermination) {
        ...
        convertApiSslTermTobTlsProtocols(apiSslTermination, dbTermination, isNewDbSslTerm);
    ...
    public static void convertApiSslTermTobTlsProtocols(org.openstack.atlas.docs.loadbalancers.api.v1.SslTermination apiSslTerm, org.openstack.atlas.service.domain.entities.SslTermination dbSslTerm, boolean newDbSslTerm) {
        if (newDbSslTerm) {
