...
public class HdfsLzo extends Entity implements Serializable {
    ...
    public String toString() {
        return "HdfsLzo{" + "hourKey=" + hourKey + ", finished=" + finished + ", reuploadNeeded=" + isReuploadNeeded() + ", md5Needed=" + isMd5Needed() + ", cfNeeded=" + isCfNeeded() + ", hdfsNeeded=" + isHdfsNeeded() + ", startTime=" + startTime + ", endTime=" + endTime + '}';
    }
