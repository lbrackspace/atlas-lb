...
public class ClusterRepository {
    ...
    public Cluster getDefaultActiveCluster(boolean public_vip) throws ClusterStatusException {
        return getDefaultActiveClusterByType(ClusterType.STANDARD, public_vip);
    }

    public Cluster getDefaultActiveClusterByType(ClusterType cluster_type, boolean public_vip) throws ClusterStatusException {
        VirtualIpType vip_type = (public_vip) ? VirtualIpType.PUBLIC : VirtualIpType.SERVICENET;
    ...
    public Cluster getActiveCluster(Integer accountId, boolean public_vip) throws ClusterStatusException, NoAvailableClusterException {
        if (accountId == null) {
            return getDefaultActiveCluster(public_vip);
        }
        ...
        try {
            return getDefaultActiveClusterByType(accountClusterType, public_vip);
