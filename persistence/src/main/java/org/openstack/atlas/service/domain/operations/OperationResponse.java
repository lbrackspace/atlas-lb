...
public class OperationResponse implements Serializable {
    ...
    public enum ErrorReason {
        ...
        UNAUTHORIZED, ENTITY_NOT_FOUND, IMMUTABLE_ENTITY, SERVICE_UNAVAILABLE, OUT_OF_VIPS, OVER_LIMIT, BAD_REQUEST, GONE, UNPROCESSABLE_ENTITY, UNKNOWN, CLUSTER_STATUS
    }
