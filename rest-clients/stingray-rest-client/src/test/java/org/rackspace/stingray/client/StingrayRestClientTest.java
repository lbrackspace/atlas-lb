...
public class StingrayRestClientTest {
    ...
    public static class WhenGettingAListOfItems {
        ...
        @Mock
        private StingrayRequestManagerUtil mockedVtmStingrayRequestManagerUtil;
        ...
        public void standUp()  throws StingrayRestClientException, StingrayRestClientObjectNotFoundException {
            ...
            mockedVtmStingrayRequestManagerUtil = new StingrayRequestManagerUtil();
        ...
        public void getItemShouldThrowExceptionWhenPathIsInvalid() throws StingrayRestClientException, StingrayRestClientObjectNotFoundException {
            stingrayRestClient.getItem("itemName", Pool.class, "BROKENPATH");
        }
        ...
        public void getMonitorScriptsShouldThrowExceptionWhenResponseIsInvalid() throws StingrayRestClientException, StingrayRestClientObjectNotFoundException{
            when(mockedResponse.readEntity((Class<Object>) Matchers.any())).thenThrow(Exception.class);
            when(mockedResponse.getStatus()).thenReturn(ClientConstants.BAD_REQUEST);            List<Child> monitorScripts = stingrayRestClient.getMonitorScripts();
        }
    ...
    public static class whenUpdatingAnItem {
        ...
        private RequestManager requestManager;
        @Mock
        private StingrayRequestManagerUtil vtmStingrayRequestManagerUtil;
        private StingrayRestClientManager stingrayRestClientManager;
        @InjectMocks
        private StingrayRestClient stingrayRestClient;
        @Mock
        ...
        @Test(expected = StingrayRestClientException.class)
        public void updateItemShouldThrowExceptionWhenPathIsInvalid() throws StingrayRestClientException, StingrayRestClientObjectNotFoundException {
            stingrayRestClient.updateItem("itemName", Pool.class, "BROKENPATH", new Pool());
        }
    ...
    public static class whenDeletingAnItem {
        ...
        @Test(expected = StingrayRestClientException.class)
        public void deleteItemShouldThrowExceptionWhenPathIsInvalid() throws StingrayRestClientException, StingrayRestClientObjectNotFoundException {
            stingrayRestClient.deleteItem("itemName","BROKENPATH");
        }
