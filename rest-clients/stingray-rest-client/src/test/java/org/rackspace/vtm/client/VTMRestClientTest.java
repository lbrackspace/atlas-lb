...
public class VTMRestClientTest {
    ...
    public static class WhenGettingAListOfItems {
        ...
        @Test
        public void getItemShouldThrowExceptionWhenPathIsInvalid() throws NoSuchMethodException {
            Method getItems = VTMRestClient.class.getDeclaredMethod("getItems", String.class);
            getItems.setAccessible(true);
            try {
                getItems.invoke(vtimRestClient, "BROKENPATH");
            } catch (Exception vex) {
                if (vex.getCause() instanceof VTMRestClientException) {
    ...
    public static class whenGettingAnItem {
        ...
        @Test
        public void getItemShouldThrowExceptionWhenPathIsInvalid() throws VTMRestClientException, VTMRestClientObjectNotFoundException, NoSuchMethodException {
            Method getItem = VTMRestClient.class.getDeclaredMethod("getItem", String.class, Class.class, String.class);
            getItem.setAccessible(true);
            try {
                getItem.invoke(vtimRestClient, "vsname", Bandwidth.class, "BROKENPATH");
            } catch (Exception vex) {
                if (vex.getCause() instanceof VTMRestClientException) {
                    Assert.assertTrue(true);
                } else {
    ...
    public static class whenUpdatingAnItem {
        ...
        @Test
        public void updateItemShouldThrowExceptionWhenPathIsInvalid() throws VTMRestClientException, VTMRestClientObjectNotFoundException, NoSuchMethodException {
            Method updateItem = VTMRestClient.class.getDeclaredMethod("updateItem", String.class, Class.class, String.class, Object.class);
            updateItem.setAccessible(true);
            try {
                updateItem.invoke(vtimRestClient, "vsname", Bandwidth.class, "BROKENPATH", bandwidth);
            } catch (Exception vex) {
                if (vex.getCause() instanceof VTMRestClientException) {
                    Assert.assertTrue(true);
                } else {
    ...
    public static class whenDeletingAnItem {
        ...
        @Test
        public void deleteItemShouldThrowExceptionWhenPathIsInvalid() throws NoSuchMethodException {
            Method deleteItem = VTMRestClient.class.getDeclaredMethod("deleteItem", String.class, String.class);
            deleteItem.setAccessible(true);
            try {
                deleteItem.invoke(vtimRestClient, "vsname", "BROKENPATH");
            } catch (Exception vex) {
                if (vex.getCause() instanceof VTMRestClientException) {
                    Assert.assertTrue(true);
                } else {
