...
public class CloudFilesSegmentContainerTest {
    ...
    public void testHourMutex() throws InterruptedException {
        ...
        Assert.assertTrue(CloudFilesSegmentContainer.setWorkingHour(hourKey));
        Assert.assertFalse(CloudFilesSegmentContainer.setWorkingHour(hourKey));
        Assert.assertFalse(CloudFilesSegmentContainer.setWorkingHour(hourKey));
        CloudFilesSegmentContainer.clearWorkingHour(hourKey);
        Assert.assertTrue(CloudFilesSegmentContainer.setWorkingHour(hourKey));
        CloudFilesSegmentContainer.clearWorkingHour(hourKey);
    }
