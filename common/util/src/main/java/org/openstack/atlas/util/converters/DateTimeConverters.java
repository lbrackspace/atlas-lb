...
public class DateTimeConverters {
    ...
    public static String calToiso(Calendar cal) throws ConverterException {
        ...
        try {
           ...
           // ZonedDateTime dateTime = ZonedDateTime.of(cal.get(Calendar.YEAR),cal.get(Calendar.MONTH),cal.get(Calendar.DAY_OF_MONTH),cal.get(Calendar.HOUR),cal.get(Calendar.MINUTE),cal.get(Calendar.SECOND), cal.get(Calendar.MILLISECOND)*1000000, ZoneOffset.UTC);
