...
public class AesTest {
    ...
    @Test
    public void testGCMEncryptAndDecryptToChar() throws NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException, InvalidKeySpecException {
    ...
    @Test
    public void testGCMEncryptAndDecryptNotEquals() throws NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException, InvalidKeySpecException {
        String key = "nZr4u7x!A%D*F-Ja";
        String test = "testt";
        String ctest = "encryptMe";
        String iv = "testiv";
