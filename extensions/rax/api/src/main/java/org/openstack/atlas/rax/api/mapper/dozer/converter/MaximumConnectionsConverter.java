...
public class MaximumConnectionsConverter implements CustomConverter {
    @Override
    public Object convert(Object existingDestinationFieldValue, Object sourceFieldValue, Class<?> destinationClass, Class<?> sourceClass) {
        ...
        if(destinationClass == Map.class) {
            ...
            otherAttributes.put((new QName("http://docs.openstack.org/atlas/api/v1.1/extensions/rax", "maxConnections", "rax")), String.valueOf((Integer)sourceFieldValue));

            return otherAttributes;
        }

        if(destinationClass == Integer.class) {
            return Integer.parseInt(ExtensionObjectMapper.<String>getOtherAttribute((Map<QName, String>) sourceFieldValue, "maxConnections"));
        }
