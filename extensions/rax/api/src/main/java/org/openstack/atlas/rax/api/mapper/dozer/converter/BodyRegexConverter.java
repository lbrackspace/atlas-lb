...
public class BodyRegexConverter implements CustomConverter {
    @Override
    public Object convert(Object existingDestinationFieldValue, Object sourceFieldValue, Class<?> destinationClass, Class<?> sourceClass) {
        ...
        if(destinationClass == Map.class) {
            ...
            otherAttributes.put((new QName("http://docs.openstack.org/atlas/api/v1.1/extensions/rax", "bodyRegex", "rax")), String.valueOf(sourceFieldValue));

            return otherAttributes;
        }

        if(destinationClass == String.class) {
            return ExtensionObjectMapper.<String>getOtherAttribute((Map<QName, String>) sourceFieldValue, "bodyRegex");
        }
