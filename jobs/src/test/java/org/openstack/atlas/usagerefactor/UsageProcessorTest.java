...
public class UsageProcessorTest {
    ...
    public static class WhenProcessingExistingEventsAndCurrentUsage {
        ...
        public void testUsageProcessor_MergeRecords() throws Exception{
            lbHostMap = usageRefactorService.getAllLoadBalancerHostUsages();//Map<lbId, Map<hostId, List<LoadBalancerHostUsage>>>
            snmpMap = UsagePollerGenerator.generateSnmpMap(numHosts, numLBs);//currentUsage as Map<hostId,Map<LBId, SnmpUsage>
            ...
            AssertLoadBalancerMergedHostUsage.containsValuesByEventType(1234, 123, 2L, 2L, 2L, 2L, 13, 11, 2, 5,
                    UsageEvent.SSL_MIXED_ON, "2013-04-10 20:02:00", result.getMergedUsages());
            ...
            AssertLoadBalancerMergedHostUsage.containsValuesByEventType(1234, 124, 2L, 2L, 2L, 2L, 15, 11, 3, 3,
                    UsageEvent.SSL_ONLY_ON, "2013-04-10 20:03:00", result.getMergedUsages());
        ...
        public String toString(LoadBalancerMergedHostUsage mergedHostUsage){
            ...
            String pollTimeStr = formatter.format(mergedHostUsage.getPollTime().getTime());
