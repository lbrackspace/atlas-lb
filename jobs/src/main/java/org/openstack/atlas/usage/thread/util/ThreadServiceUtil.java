...
public class ThreadServiceUtil {
    ...
    public static ThreadPoolMonitorService startThreadMonitor(ScheduledThreadPoolExecutor taskExecutor, ThreadPoolMonitorService threadPoolMonitorService) {
        Thread monitor = null;
        try {
...
//            taskExecutor = threadPoolExecutorService.createNewThreadPool(corePoolSize, maxPoolSize, keepAliveTime, QUERY_CAPACITY, new RejectedExecutionHandler());
    ...
    public static boolean shutDownAHUSLServices(ScheduledThreadPoolExecutor taskExecutor, ThreadPoolMonitorService threadPoolMonitorService, AtomHopperClient atomHopperClient) {
        try {
