...
public class HostMachineDetailsTest {
    ...
    public static class WhenMappingHostDataModeToRestMachineDetails {
        ...
        public void shouldMapHostProperties() {
            ...
            Assert.assertEquals(host.getSoapEndpointActive(), dHostMD.getHost().getSoapEndpointActive());
            Assert.assertEquals(host.getRestEndpointActive(), dHostMD.getHost().getRestEndpointActive());
        }
        //TODO:more test
    }
}
