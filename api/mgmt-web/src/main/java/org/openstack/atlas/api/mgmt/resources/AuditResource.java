...
public class AuditResource extends ManagementDependencyProvider {
    ...
    public Response runExpiredCertCheck() {
        ...
        for (SslTermInfoDb dbSslTermInfo : sslTermsFromDb) {
            ...
            apiTermInfo.setAccountId(dbSslTermInfo.getAccountId());
            ...
            String imds = dbSslTermInfo.getIntermediateCertificate();
            ...
            if (zcf.hasFatalErrors()) {
                ...
                fatalErrors = zcf.getFatalErrorList();
                apiTermInfo.getErrors().addAll(fatalErrors);
            } else {
