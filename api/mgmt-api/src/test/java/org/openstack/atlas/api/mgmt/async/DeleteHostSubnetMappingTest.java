...
public class DeleteHostSubnetMappingTest extends VTMTestBase {
    ...
    public void standUp() {
        ...
        mgmtDeleteHostSubnetMappingListener = new MgmtDeleteHostSubnetMappingListener();
        mgmtDeleteHostSubnetMappingListener.setHostService(hostService);
        mgmtDeleteHostSubnetMappingListener.setNotificationService(notificationService);
        mgmtDeleteHostSubnetMappingListener.setUsageEventCollection(usageEventCollection);
