...
import org.openstack.atlas.api.async.DeleteNodeListener;
...
public class MgmtDeleteNodeListenerTest extends VTMTestBase {
    ...
    @InjectMocks
    private MgmtDeleteNodeListener deleteNodeListener;
    ...
    public void standUp() throws JMSException {
        ...
        deleteNodeListener = new MgmtDeleteNodeListener();
