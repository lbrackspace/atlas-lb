...
public class HealthMonitorValidatorTest {
    ...
    public static class whenValidatingPost {
        ...
        @Test//TODO HTTP monitor required fields: path, bodyregex, statusregex along with Type, delay, timeout, attemptsBeforeDeactivation
        public void ShouldAcceptValidHttpHealthMonitor() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "3", null, null, null);
            result = hmv.validate(hm, POST);
            assertTrue(resultMessage(result, POST), result.passedValidation());
        }
        ...
        public void ShouldRejectInvalidHttpDelayRangeMax() {
            hm = initHealthMonitor(null, HTTP, "3601", "10", "3", null, null, null);
            result = hmv.validate(hm, POST);
            assertFalse(resultMessage(result, POST), result.passedValidation());
        }
        ...
        public void shouldRejectInvalidHttpTimeoutRangeMin() {
            hm = initHealthMonitor(null, HTTP, "10", "0", "3", null, null, null);
            result = hmv.validate(hm, POST);
            assertFalse(resultMessage(result, POST), result.passedValidation());
        }
        ...
        public void ShouldRejectInvalidHttpTimeoutRangeMax() {
            hm = initHealthMonitor(null, HTTP, "10", "301", "3", null, null, null);
            result = hmv.validate(hm, POST);
            assertFalse(resultMessage(result, POST), result.passedValidation());
        }
        ...
        public void ShouldRejectInvalidHttpABDRangeMin() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "0", null, null, null);
            result = hmv.validate(hm, POST);
            assertFalse(resultMessage(result, POST), result.passedValidation());
        }
        ...
        public void ShouldRejectInvalidHttpABDRangeMax() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "11", null, null, null);
            result = hmv.validate(hm, POST);
            assertFalse(resultMessage(result, POST), result.passedValidation());
        }
        ...
        @Test
        public void shouldAcceptValidStatusRegex() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "10", "/", "^[234][0-9][0-9]$", null);
            result = hmv.validate(hm, POST);
            assertTrue(resultMessage(result, POST), result.passedValidation());
        }
        ...
        @Test
        public void shouldAcceptValidBodyRegex() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "3", "/", null, "^[234][0-9][0-9]$");
            result = hmv.validate(hm, POST);
            assertTrue(resultMessage(result, POST), result.passedValidation());
        }
        ...
        @Test
        public void shouldAcceptValidPath() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "3", "/", null, null);
            result = hmv.validate(hm, POST);
            assertTrue(resultMessage(result, POST), result.passedValidation());
        }
        ...
        @Test
        public void shouldAcceptValidPathWithLongPath() {
            hm = initHealthMonitor(null, HTTP, "10", "10", "3", "/fail/this/should/not/fail", null, null);
            result = hmv.validate(hm, POST);
            assertTrue(resultMessage(result, POST), result.passedValidation());
        }
