...
public class UsageResourceTest {
    ...
    public static class whenRetrievingUsage {
        ...
        @Test
        public void shouldReturn400whenRetrievingUsageWithBadEndDate() {
            Response response = usageResource.retrieveUsage("2021-12-21T12:32:07-06:00", "06/01/2021", 0, 1);
            Assert.assertEquals(400, response.getStatus());
            Assert.assertEquals("Date parameters must follow ISO-8601 format", ((GeneralFault) response.getEntity()).getMessage());
        }

        @Test
        public void shouldReturn400whenRetrievingUsageWithBadStartDate() {
            Response response = usageResource.retrieveUsage("05/01/2021", "2021-12-21T12:32:07-06:00", 0, 1);
            Assert.assertEquals(400, response.getStatus());
            Assert.assertEquals("Date parameters must follow ISO-8601 format", ((GeneralFault) response.getEntity()).getMessage());
        }
        ...
        @Test
        public void shouldReturn400whenRetrievingUsageWithStartDateAfterEnddate() {
            Response response = usageResource.retrieveUsage("2010-12-21T12:32:07-06:00", "2009-12-21T12:32:07-06:00", 0, 1);
            Assert.assertEquals(400, response.getStatus());
            Assert.assertEquals("Must specify an earlier startTime than endTime.", ((GeneralFault) response.getEntity()).getMessage());
        }
