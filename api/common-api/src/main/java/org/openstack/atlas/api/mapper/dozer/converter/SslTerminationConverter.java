...
public class SslTerminationConverter implements CustomConverter {
    ...
    public Object convert(Object dstValue, Object srcValue, Class dstClass, Class srcClass) {
        ...
        if (srcValue.getClass() == apiSslTermClass && dstClass == dbSslTermClass) {
            ...
            for (SecurityProtocol sp : securityProtocols) {
                    ...
                    case TLS_10:
                        switch (sp.getSecurityProtocolStatus()) {
                            ...
                            case ENABLED:
                                ...
                                break;
                            default:
                                dbSslTerm.setTls10Enabled(true); // By default assume this is enabled
                                break; // leave tls10 to null in the DB if its not specified
                        }
