...
public class MetadataDeserializer extends JsonDeserializer {
    ...
    private final Log LOG = LogFactory.getLog(MetadataDeserializer.class);
    ...
    public MetadataDeserializer(Class forClass,Class itemClass,String getterName) {
