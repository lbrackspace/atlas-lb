...
public class DeleteNodesListener extends BaseListener {
    ...
    public void doOnMessage(final Message message) throws Exception {
        ...
        try {
                LOG.debug(String.format("Removing nodes '[%s]' from load balancer '%d' in backend...", doomedIdsStr, msg.getLoadBalancerId()));
                ...
                LOG.debug(String.format("Successfully removed nodes '[%s]' from load balancer '%d' in backend.", doomedIdsStr, msg.getLoadBalancerId()));
        } catch (Exception e) {
            loadBalancerService.setStatus(dbLoadBalancer, LoadBalancerStatus.ERROR);
            String alertDescription = String.format("Error removing nodes '%s' backend.. for loadbalancer '%d'.", doomedIdsStr, msg.getLoadBalancerId());
        ...
        //Refresh dbLb for updated node list
