...
public class DeleteErrorFileListener extends BaseListener {
    ...
    public void doOnMessage(final Message message) throws Exception {
        ...
        if (data.getAccountId() != null && data.getLoadBalancerId() != null) {
            ...
            try {
                    LOG.debug(String.format("Deleting error file for %s in backend...", dbLoadBalancer.getId()));
                    ...
                    LOG.debug(String.format("Successfully deleted error file for %s backend.....", dbLoadBalancer.getId()));
            } catch (Exception e) {
