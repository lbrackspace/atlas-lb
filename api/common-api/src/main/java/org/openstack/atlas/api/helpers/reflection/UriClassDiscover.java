...
public class UriClassDiscover {
    ...
    static {
        ...
        getrList().add(new REFCN(".*\\d+/loadbalancers/bounce/sslterminationvalidation(\\.json|\\.xml)?/?$", SslTermination.class));
        ...
        getrList().add(new REFCN(".*/management/clusters/\\d+(\\.json|\\.xml)?/?$", org.openstack.atlas.docs.loadbalancers.api.management.v1.Cluster.class));
