...

            {
                ...
                must().adhereTo(new Verifier<SslTermination>() {
                    ...
                    public VerifierResult verify(SslTermination ssl) {
                        if ((ssl.getCertificate() == null || ssl.getPrivatekey() == null || ssl.getIntermediateCertificate() == null) && ((ssl.getEnabled() != null && (ssl.getSecureTrafficOnly() != null) && ssl.getIntermediateCertificate() != null && ssl.getSecurePort() != null && ssl.getCipherProfile() !=null))) {
                ...
                must().adhereTo(new Verifier<SslTermination>() {
                    ...
                    @Override
                    public VerifierResult verify(SslTermination ssl) {
                        if ((ssl.getCertificate() == null && ssl.getPrivatekey() == null && ssl.getIntermediateCertificate() == null) && (ssl.getEnabled() == null && (ssl.getSecureTrafficOnly() == null) && !hasSecurityProtocols(ssl) && ssl.getIntermediateCertificate() == null && ssl.getSecurePort() == null && ssl.getCipherProfile() ==null)) {
                            return new VerifierResult(false);
                        }
                        return new VerifierResult(true);
                    }
                ...
                must().adhereTo(new Verifier<SslTermination>() {
                    ...
                    @Override
                    public VerifierResult verify(SslTermination ssl) {
                        if ((ssl.getCertificate() == null || ssl.getPrivatekey() == null && ssl.getIntermediateCertificate() == null) && (ssl.getEnabled() == null && (ssl.getSecureTrafficOnly() == null) && ssl.getSecurePort() == null && !hasSecurityProtocols(ssl) && ssl.getCipherProfile() ==null)) {
                            return new VerifierResult(false);
                        }
                        return new VerifierResult(true);
                    }
