        ...
        validator = build(new ValidatorBuilder<LoadBalancer>(LoadBalancer.class) {
            {
                ...
                result(validationTarget().getVirtualIps()).must().delegateTo(new VirtualIpsValidator().getValidator(), POST);
...
//                result(validationTarget().getVirtualIps().getVirtualIps()).if_().exist().then().must().delegateTo(new VirtualIpValidator().getValidator(), POST).forContext(POST);
                ...
                result(validationTarget().getAccessList()).if_().exist().then().must().delegateTo(new AccessListValidator().getValidator(), POST);
...
//                result(validationTarget().getAccessList().getNetworkItems()).if_().exist().then().must().delegateTo(new NetworkItemValidator().getValidator(), POST).forContext(POST);
                result(validationTarget().getNodes()).must().delegateTo(new NodesValidator().getValidator(), POST);
...
//                result(validationTarget().getNodes().getNodes()).if_().exist().then().must().cannotExceedSize(25).withMessage("Must not provide more than twenty five nodes per load balancer.");
                result(validationTarget().getMetadata()).must().delegateTo(new MetadataValidator().getValidator(), POST);
