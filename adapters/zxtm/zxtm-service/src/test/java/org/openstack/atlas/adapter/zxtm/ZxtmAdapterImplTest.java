...
public class ZxtmAdapterImplTest {
    ...
    public static class WhenTestingOrderOfZeusApiCalls {
        ...
        public void standUp() throws RemoteException, MalformedURLException {
            ...
            ((ZxtmAdapterImpl)(doReturn(serviceStubs).when(adapterSpy))).getServiceStubs(Matchers.<LoadBalancerEndpointConfiguration>anyObject());
        ...
        @Test
        public void shouldRunInOrderWhenCreatingASimpleLoadBalancer() throws AdapterRollBackException, InsufficientRequestException, RemoteException {
...
//            inOrder.verify(vsStub).getProtocol(Matchers.<String[]>any());
        ...
        @Test
        public void shouldRunInOrderWhenCreatingAFullyConfiguredLoadBalancer() throws AdapterRollBackException, InsufficientRequestException, RemoteException {
        ...
        @Test
        public void shouldRunInOrderWhenDeletingALoadBalancer() throws AdapterRollBackException, InsufficientRequestException, RemoteException {
