package org.openstack.atlas.service.domain.service.helpers;
...
public class AtomHelper {
    ...
    public static String createRelativeUri(Integer accountId, Integer loadblancerId, EventType eventType, Integer additionalId) {
        ...
        } else if (eventType.equals(EventType.SET_HEALTH_MONITOR) || eventType.equals(EventType.DELETE_HEALTH_MONITOR)) {
