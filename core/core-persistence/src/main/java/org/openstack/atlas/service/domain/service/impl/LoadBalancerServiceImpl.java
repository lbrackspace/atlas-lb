...
import static org.openstack.atlas.service.domain.common.NodesHelper.*;
import static org.openstack.atlas.service.domain.entity.LoadBalancerProtocol.HTTP;
import static org.openstack.atlas.service.domain.entity.LoadBalancerStatus.*;
...
*/
    ...
    public void addDefaultValues(LoadBalancer loadBalancer) {
        ...
        setNodesToStatus(loadBalancer, NodeStatus.ONLINE);
