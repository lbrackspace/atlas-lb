...
import org.openstack.atlas.service.domain.pojo.Customer;
import org.openstack.atlas.service.domain.pojo.LoadBalancerCountByAccountIdHostId;
...
*/
    ...
    public Host getDefaultActiveHost() throws EntityNotFoundException {
        return hostRepository.getDefaultActiveHost();
    }
