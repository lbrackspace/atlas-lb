...
public interface NotificationService {
    ...
    void saveConnectionLimitEvent(String userName, Integer accountId, Integer loadbalancerId, Integer connectionLimitId, String title, String desc, EventType eventType, CategoryType category, EventSeverity severity);
