...
INSERT INTO `virtual_ipv4` VALUES (1,'10.0.0.1', FALSE, NULL, NULL ,'PUBLIC',1)
                                  ...
                                  ,(11,'10.0.0.11', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(12,'10.0.0.12', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(13,'10.0.0.13', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(14,'10.0.0.14', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(15,'10.0.0.15', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(16,'10.0.0.16', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(17,'10.0.0.17', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(18,'10.0.0.18', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(19,'10.0.0.19', FALSE, NULL, NULL ,'PRIVATE',1)
                                  ,(20,'10.0.0.20', FALSE, NULL, NULL ,'PRIVATE',1);
