...
public class LoadBalancerValidator implements ResourceValidator<LoadBalancer> {
    ...
    public LoadBalancerValidator() {
        validator = build(new MyBuilder(LoadBalancer.class));
    }
    ...
    protected class MyBuilder extends ValidatorBuilder<LoadBalancer> {
        {
            // SHARED EXPECTATIONS
        ...
        public MyBuilder(Class<LoadBalancer> type) {
            super(type);
        }
    }
