...
public class SnmpSamplerMain {
    ...
    public static void main(String[] argv) {
        ...
        String appendFile;
        if (argv.length < 2) {
            System.out.printf("usage is <config file> <appendFile>\n");
            return;
        }
        configFile = argv[0];
        appendFile = argv[1];
        System.out.printf("using config file %s to write %s output\n", configFile, appendFile);
    }

    public static void mainDeprecated(String[] MainArgs) throws IOException {
