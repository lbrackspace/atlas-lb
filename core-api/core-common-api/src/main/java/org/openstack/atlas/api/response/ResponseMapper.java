...
import org.openstack.atlas.core.api.v1.exceptions.*;
import org.openstack.atlas.service.domain.exception.*;
import org.openstack.atlas.service.domain.operation.OperationResponse;
import org.openstack.atlas.service.domain.operation.OperationResponse.ErrorReason;
...
public class ResponseMapper {
    ...
    public static LbaasException getFault(ErrorReason errorReason, String message, String details) {
        LoadBalancerException lbf = new LoadBalancerException();
        lbf.setMessage("");
        lbf.setDetails("");
    ...
    public static LbaasException getFault(Exception e, String message, String details) {
        if (message == null) {
