...
public class VTMAdapterResources {
    ...
    public void updateVirtualServer(VTMRestClient client, String vsName, VirtualServer virtualServer) throws VTMRollBackException {
    ...
    public void updateKeypair(VTMRestClient client, String vsName, Keypair keypair) throws VTMRollBackException {
    ...
    public void deleteKeypair(VTMRestClient client, String vsName) throws VTMRollBackException {
        ...
        try {
            ...
            throw new VTMRollBackException(em, clientException);
        }
    }
    ...
    public void updateProtection(VTMRestClient client, String protectionName, Protection protection) throws InsufficientRequestException, VTMRollBackException {
    ...
    public void deleteProtection(VTMRestClient client, String protectionName)
            throws VTMRollBackException, InsufficientRequestException {
    ...
    public void setRateLimit(LoadBalancerEndpointConfiguration config, LoadBalancer loadBalancer, String vsName) throws InsufficientRequestException, VTMRollBackException {
        VTMRestClient client = loadVTMRestClient(config);
        ...
        try {
            ...
            client.destroy();
            throw new VTMRollBackException("Add rate limit request canceled.", e);
    ...
    public void updateRateLimit(LoadBalancerEndpointConfiguration config, LoadBalancer loadBalancer, String vsName) throws InsufficientRequestException, VTMRollBackException {
        VTMRestClient client = loadVTMRestClient(config);
        VTMResourceTranslator rt = new VTMResourceTranslator();
        ...
        try {
            ...
            client.destroy();
            throw new VTMRollBackException("Update rate limit request canceled.", e);
        } catch (VTMRestClientException e) {
            LOG.error(String.format("Failed to update rate limit for virtual server %s -- REST Client exception", vsName));
            client.destroy();
            throw new VTMRollBackException("Update rate limit request canceled.", e);
    ...
    public void deleteRateLimit(LoadBalancerEndpointConfiguration config, LoadBalancer loadBalancer, String vsName) throws VTMRollBackException, InsufficientRequestException {
        VTMRestClient client = loadVTMRestClient(config);
        ...
        try {
            ...
            client.destroy();
            throw new VTMRollBackException("Delete rate limit request canceled.", e);
        }
    ...
    public void setErrorFile(LoadBalancerEndpointConfiguration config, VTMRestClient client, LoadBalancer loadBalancer, String content) throws InsufficientRequestException, VTMRollBackException {
        String virtualServerName = VTMNameBuilder.genVSName(loadBalancer.getId(), loadBalancer.getAccountId());
        Map<VTMAdapterUtils.VSType, String> vsNames = VTMAdapterUtils.getVSNamesForLB(loadBalancer);
        ...
        try {
            ...
            throw new VTMRollBackException(String.format("Failed creating error file for: %s.", virtualServerName), e);
        }
        ...
        try {
            ...
            throw new VTMRollBackException(String.format("Failed creating error page for: %s.", virtualServerName), e);
        } catch (VTMRestClientException e) {
            // Failed to create error file, error out..
            LOG.error(String.format("Failed to set ErrorFile for %s Exception: %s -- exception", virtualServerName, e));
            throw new VTMRollBackException(String.format("Failed creating error page for: %s.", virtualServerName), e);
    ...
    public void deleteErrorFile(LoadBalancerEndpointConfiguration config, VTMRestClient client, LoadBalancer loadBalancer)
        ...
        try {
            ...
            throw new VTMRollBackException("Deleting error file cancelled.", e);
        }
    }

    public File getFileWithContent(String content) throws IOException {
        File file = File.createTempFile("VTMAdapterImpl_", ".err");
