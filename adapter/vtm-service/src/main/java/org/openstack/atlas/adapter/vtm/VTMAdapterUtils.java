...
public class VTMAdapterUtils {
    ...
    public static Map<VSType, String> getVSNamesForLB(LoadBalancer loadBalancer) throws InsufficientRequestException {
        ...
        String virtualServerName = VTMNameBuilder.genVSName(lbId, accountId);
        String virtualSecureServerName = VTMNameBuilder.genSslVSName(lbId, accountId);
        String virtualRedirectServerName = VTMNameBuilder.genRedirectVSName(lbId, accountId);
        String[] vsNames;
