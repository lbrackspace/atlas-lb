...
//    @Ignore
//    @Test
//    public void visualConfirmTest() throws StmRollBackException, InsufficientRequestException, .VTMRestClientObjectNotFoundException, .VTMRestClientException {
//        List<Child> trafficManagerList = vtmClient.getTrafficManagers();
//
//        for (Child c : trafficManagerList) {
//            String trafficManagerName = c.getName();
//            TrafficManager trafficManager = vtmClient.getTrafficManager(trafficManagerName);
