...
public class SetNodesITest extends VTMTestBase {
    ...
    public void testSetNodes() throws Exception {
        ...
        List<PoolNodesTable> poolNodesTable = vtmClient.getPool(vsName).getProperties().getBasic().getNodesTable();
    ...
    public void testRemoveNode() throws Exception {
        ...
        vtmAdapter.removeNode(config, lb, nodeToRemove);
...
//        createdNodes.remove(nodesToRemove);
        ...
        vtmAdapter.removeNodes(config, lb, nodesToRemove);
