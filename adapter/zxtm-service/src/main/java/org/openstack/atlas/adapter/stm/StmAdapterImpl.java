...
public class StmAdapterImpl implements ReverseProxyLoadBalancerStmAdapter {
    ...
    */
    ...
    public void addCertificateMappingSOAP(LoadBalancerEndpointConfiguration config, Integer lbId, Integer accountId, CertificateMapping certMappingToUpdate) throws RemoteException, InsufficientRequestException, ZxtmRollBackException {
