...
public class CustomMappings {
    ...
    public static Stats mapVirtualServer7Stats(org.rackspace.vtm.client.counters.VirtualServerStats virtualServerStats, org.rackspace.vtm.client.counters.VirtualServerStats virtualServerStatsSsl) {
        Stats stats = new Stats();
    ...
    public static Stats mapVirtualServer7StatsLists(List<org.rackspace.vtm.client.counters.VirtualServerStats> virtualServerStats, List<org.rackspace.vtm.client.counters.VirtualServerStats> virtualServerStatsSsl) {
        long connectionTimedOut = 0L;
        long connectionError = 0L;
        long connectionFailure = 0L;
        long dataTimedOut = 0L;
        ...
        for (org.rackspace.vtm.client.counters.VirtualServerStats vss : virtualServerStats) {
        ...
        for (org.rackspace.vtm.client.counters.VirtualServerStats vsss : virtualServerStatsSsl) {
