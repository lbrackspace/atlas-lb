        ...
        try {
            if (throttle != null) {
                ...
                if (throttle.getMinConnections() != null) {
                    ...
                    serviceStubs.getProtectionBinding().setMinConnections(new String[]{protectionClassName}, new UnsignedInt[]{new UnsignedInt(ConnectionThrottleDefaultContants.getMinConnections())});
                }

                if (throttle.getRateInterval() != null) {
                    // Set the rate interval for the rates
                    serviceStubs.getProtectionBinding().setRateTimer(new String[]{protectionClassName}, new UnsignedInt[]{new UnsignedInt(ConnectionThrottleDefaultContants.getRateInterval())});
                }
                ...
                if (throttle.getMaxConnectionRate() != null) {
                    ...
                    serviceStubs.getProtectionBinding().setMaxConnectionRate(new String[]{protectionClassName}, new UnsignedInt[]{new UnsignedInt(ConnectionThrottleDefaultContants.getMaxConnectionRate())});
                }
