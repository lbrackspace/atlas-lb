...
public class StmAdapterImplTest extends StmAdapterImplTestHelper {
    ...
    public static class WhenModifyingPoolResources {
        ...
        public void standUp() throws Exception {
            ...
            Pool p = new Pool();
            org.rackspace.stingray.pojo.pool.Properties pp = new org.rackspace.stingray.pojo.pool.Properties();
            org.rackspace.stingray.pojo.pool.Basic pb = new org.rackspace.stingray.pojo.pool.Basic();
            pp.setBasic(pb);
            p.setProperties(pp);
    ...
    public static class WhenSuspendingLoadBalancer {
        ...
        public void standUp() throws Exception {
            ...
            virtualServer.setProperties(new Properties());
            virtualServer.getProperties().setBasic(new Basic());
            virtualServerSecure = new VirtualServer();
            virtualServerSecure.setProperties(new Properties());
            virtualServerSecure.getProperties().setBasic(new Basic());
