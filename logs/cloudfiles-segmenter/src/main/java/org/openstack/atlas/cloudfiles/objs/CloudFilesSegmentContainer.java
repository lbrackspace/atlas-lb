...
public class CloudFilesSegmentContainer {
    ...
    public static CloudFilesSegmentContainer newSegmentContainer(String fileName, int segmentSize) {
    ...
    public static CloudFilesSegmentContainer threadedSegmentFile(String filePath, int segmentSize) {
